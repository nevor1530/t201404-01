<div class="do-paper">
	<div class="paper-left-column">
		...
		<div class="btn green-btn">
			<a href="<?php echo Yii::app()->createUrl("/practise/viewPractiseAnalysis", array('exam_bank_id'=>$this->examBankId, 'subject_id'=>$this->curSubjectId, 'exam_paper_instance_id' => $exam_paper_instance_id))?>">查看解析</a>
		</div>
	</div>
