<ul class="subfunction-list">
	<li class="current">推荐真题</li>
    <li><a href="<?php echo Yii::app()->createUrl("/realExamPaper/list", array('exam_bank_id'=>$this->examBankId, 'subject_id'=>$this->curSubjectId))?>">全部真题</a></li>
</ul>
