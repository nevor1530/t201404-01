...
<div style="margin-bottom:20px;">
	...
	<div style="padding-top:10px;border-top:dashed 1px #000;"><?php echo $materialContent ?></div>
</div>
...
<div style="margin-bottom:40px;">
	<div style="margin-bottom:5px;">
		...
		<span style="margin-left:5px;margin-right:5px" class="pull-right">|</span>
		<a class="pull-right" href="<?php echo Yii::app()->createUrl("/admin/question/updateQuestion", array("subject_id"=> $subject_id,"question_id"=>$question['id'], "material_id" => $material_id, "return_url" => urlencode(Yii::app()->request->url)));?>" style="margin-right:5px">编辑题目</a>
	</div>
