...
$this->sideNav=array(
	...
	array('label'=>'试卷分类', 'url'=>array('/admin/category/index', 'subject_id'=>$subjectModel->subject_id)),
	array('label'=>'考点树', 'url'=>array('/admin/examPoint/index', 'subject_id'=>$subjectModel->subject_id)),
