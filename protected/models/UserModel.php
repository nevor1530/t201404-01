...
class UserModel extends ActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'examPaperInstances' => array(self::HAS_MANY, 'ExamPaperInstance', 'user_id'),
			'payments' => array(self::HAS_MANY, 'Payment', 'user_id'),
			'payrecords' => array(self::HAS_MANY, 'Payrecord', 'user_id'),
			'questionInstances' => array(self::HAS_MANY, 'QuestionInstance', 'user_id'),
		);
	}
